...
const getBadges = (profile: UserProfile): Badge[] => {
  const badges: Badge[] = [
    ...
    },
    {
      ...
      icon: <VerifiedIcon />,
      color: '#9C27B0',
      description: 'Added profile tags',
      earned: profile.tags && profile.tags.length >= 3,
    },
    {
      id: 'well_tagged',
      name: 'Well Tagged',
      icon: <VerifiedIcon />,
      color: '#673AB7',
      description: 'Added 5+ profile tags',
      earned: profile.tags && profile.tags.length >= 5,
    },
    {
      id: 'rated',
      name: 'Rated',
      icon: <StarIcon />,
      color: '#FF5722',
      description: 'Received first rating',
      earned: profile.stats.ratings_received >= 1,
    },
    {
      id: 'popular',
      name: 'Popular',
      icon: <FavoriteIcon />,
      color: '#E91E63',
      description: 'Received 5 ratings',
      earned: profile.stats.ratings_received >= 5,
    },
    {
      ...
      earned: profile.stats.ratings_received >= 10,
    },
    {
      id: 'helper',
      name: 'Helper',
